...
class JoystickController(Node):
    def __init__(self):
        ...
        self.max_pan_error = 20
        self.max_tilt_error = 20
        self.pan_kp = 0.0
        self.pan_ki = 0.0
        self.pan_kd = 0
        self.tilt_kp = 0
        ...
        pan_initial_state_covariance = np.array([[20]])
        ...
        self.pan_kalman_covariance = np.array([[20]])
        ...
        tilt_initial_state_covariance = np.array([[20]])
        ...
        # Initialize the pan_kalman_covariance as a 1x1 matrix
        self.tilt_kalman_covariance = np.array([[20]])
    ...
    def move_servos_with_error(self, errorX, errorY):
        ...
        #target_tilt = self.current_tilt + (errorY * tilt_scaled_increment) - 7
